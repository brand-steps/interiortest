  ...
  return (
    ...
    <div className='flex  justify-evenly flex-wrap my-4' >
      <div style={containerStyle}>
        <h1 className='heads'>list of Global Trusted Signal groups</h1>
...
<div className='flex  justify-evenly flex-wrap my-4' >
      <div style={containerStyle}>
        <h1 className='heads'>Want to List your Forex Signal Group?</h1>
        <button onClick={() => {navigate("/addsignalgroup")}}
