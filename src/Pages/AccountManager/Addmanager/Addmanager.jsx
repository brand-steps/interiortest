...
//        alert("you have successfully registered for Global trusted signal group");
  ...
  return (
    ...
    <div class="space-y-6">
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Register for Global Trusted Forex Account Manager
</h5>
        <div>
            <label for="groupname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account Manager's Name</label>
        ...
        <div>
            <label for="whatsapp" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Whatsapp Number</label>
        ...
        <div>
            <label for="totalclients" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total clients</label>
